...
<head>
    ...
    <title>Belanja Online -Register</title>
                ...
                <form action="{{ url('/register') }}" method="post">
                    ...
                    <div class="panel panel-body login-form">
                        <div class="text-center">
                            ...
                            <h5 class="content-group" style="font-size: 24px; color: #666; font-weight: 800">Register to Belanja Online</h5>
                        </div>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn bg-pink-400 btn-block">Sign up <i class="icon-circle-right2 position-right"></i></button>
                        </div>
